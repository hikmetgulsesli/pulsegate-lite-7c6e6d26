...
- PulseGate Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PulseGate Lite. It should be a full-viewport arcade reflex game where the player steers a pulse through timed gates, collects energy, avoids overload zones, has a settings overlay, score/level HUD, pause/resume, restart, keyboard and click controls, and must be playable lo…
...
- Gameplay - PulseGate Lite
- Game Settings - PulseGate Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PulseGate Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PulseGate Lite
